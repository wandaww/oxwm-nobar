...
A fork of [oxwm](https://github.com/tonybanters/oxwm) with the built-in bar removed and replaced with support for external bars like [EWW](https://github.com/elkowar/eww), Polybar, or any other external bar.
...
- [tonybanters/oxwm](https://github.com/tonybanters/oxwm) — the original oxwm project
- [elkowar/eww](https://github.com/elkowar/eww) — the external bar this fork is designed for
